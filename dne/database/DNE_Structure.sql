CREATE DATABASE  IF NOT EXISTS `dne` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `dne`;
-- MySQL dump 10.13  Distrib 5.5.16, for Win32 (x86)
--
-- Host: localhost    Database: dne
-- ------------------------------------------------------
...
CREATE TABLE `address` (
  ...
  `logradouro` varchar(110) DEFAULT NULL,
  ...
  `restricao` varchar(110) DEFAULT NULL,
...
CREATE TABLE `restriction` (
  ...
  `restricao` varchar(110) DEFAULT NULL,
  `processado` varchar(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2016-07-01 20:02:44
